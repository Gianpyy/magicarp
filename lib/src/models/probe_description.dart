...
class ProbeDescription {
  ...
  static Map<String, Icon> get probeTypeIcon => {
    ...
    const Icon(Icons.get_app, size: 50, color: CACHET.LIGHT_GREEN),
    CommunicationSamplingPackage.TEXT_MESSAGE_LOG:
    const Icon(Icons.textsms, size: 50, color: CACHET.LIGHT_PURPLE),
    CommunicationSamplingPackage.TEXT_MESSAGE:
    const Icon(Icons.text_fields, size: 50, color: CACHET.LIGHT_PURPLE),
    CommunicationSamplingPackage.PHONE_LOG:
    const Icon(Icons.phone_in_talk, size: 50, color: CACHET.ORANGE),
    CommunicationSamplingPackage.CALENDAR:
    const Icon(Icons.event, size: 50, color: CACHET.CYAN),
    DeviceSamplingPackage.SCREEN_EVENT:
    const Icon(Icons.screen_lock_portrait, size: 50, color: CACHET.LIGHT_PURPLE),
    ContextSamplingPackage.CURRENT_LOCATION:
    const Icon(Icons.location_searching, size: 50, color: CACHET.CYAN),
    ContextSamplingPackage.LOCATION:
    const Icon(Icons.my_location, size: 50, color: CACHET.YELLOW),
